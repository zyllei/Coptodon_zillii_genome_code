...
p<-p+ggtitle("Statistics of Enrichment") + xlab("Rich factor") +ylab("")
...
p
ggsave(paste(args[2],"/",args[1],".","Enriched_pathway_plot.png",sep=""), plot=p,type="cairo-png", width=8, height=7, dpi=700)
ggsave(paste(args[2],"/",args[1],".","Enriched_pathway_plot.pdf",sep=""), plot=p, width=8, height=7)
