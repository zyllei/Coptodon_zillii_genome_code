...
save(all.child,all.aces,all.off,all.parent,bp.level3,cc.level3,mf.level3,bp.aces,cc.aces,mf.aces,goOnto,
     genefreq.mf,genefreq.bp,genefreq.cc,bp.off,cc.off,mf.off,bpchild,ccchild,mfchild,
     sort.data.frame,DiffGOs,GOfreq,EnrichGO,EnrichGOallLevl,file="MetaGO.RData")
